-- ============================================================
-- Report: 3.AR_Credit Memo_ใบลดหนี้_(Batch_Serial).rpt
Path:   2. Sales - AR\7. AR Credit Memo\ต้นฉบับ\3.AR_Credit Memo_ใบลดหนี้_(Batch_Serial).rpt
...
CASE WHEN ORIN.U_CN_05 IS NULL THEN ''
  WHEN ORIN.U_CN_05 IS NOT NULL THEN N'เนื่องจาก' + ORIN.U_CN_05
