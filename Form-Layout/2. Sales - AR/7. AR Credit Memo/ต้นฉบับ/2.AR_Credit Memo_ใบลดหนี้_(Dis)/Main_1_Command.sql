-- ============================================================
-- Report: 2.AR_Credit Memo_ใบลดหนี้_(Dis).rpt
Path:   2. Sales - AR\7. AR Credit Memo\ต้นฉบับ\2.AR_Credit Memo_ใบลดหนี้_(Dis).rpt
...
LEFT JOIN OINV ON ORIN.AnnInvDecR = OINV.DocEntry 
